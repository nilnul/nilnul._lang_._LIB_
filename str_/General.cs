...
{
	/// <summary>
	/// a lang might be a str of langs: we first interpret one lang into second, then to third.
	/// eg:
	...
	/// </summary>
	/// <remarks>
	/// in translation, we translate english into chinese, then from chinese into a colloquial plain dialect;
	/// </remarks>
	class General
	{
