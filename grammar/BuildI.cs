...
*/
	...
	/// <see cref="ILang"/> is linear; to represent nonlinear structure, we need special parsing rules to parse some component for reconstructing a structure; <see cref="nilnul.lang.IRun"/>, <see cref="_lang.ISyntax"/>;
	/// <summary>
	/// 
	/// </summary>
